...
**Blocked by:** 08 - Web Export CSV + lifecycle, 09 - Capacity envelope.
...
- [ ] Shared web behavior runs automatically against Chromium, Firefox, and WebKit; a smoke pass against current stable Chrome, Edge, Firefox, and Safari is documented as the release checklist.
